...
class candidates(db.Model):
    ...
    request_raised_date=db.Column(db.String,nullable=False)
    tsin_opened_date=db.Column(db.String,nullable=False)
    resume_screened_date=db.Column(db.String,nullable=False)
    l1_interview_date=db.Column(db.String,nullable=False)
    l1_interviewer=db.Column(db.String,nullable=False)
    l1_interview_result=db.Column(db.String,nullable=False)
    l1_interview_remarks=db.Column(db.String,nullable=False)
    l2_interview_date=db.Column(db.String,nullable=False)
    l2_interviewer=db.Column(db.String,nullable=False)
    l2_interview_result=db.Column(db.String,nullable=False)
    l2_interview_remarks=db.Column(db.String,nullable=False)
    l3_interview_date=db.Column(db.String,nullable=False)
    l3_interviewer=db.Column(db.String,nullable=False)
    l3_interview_result=db.Column(db.String,nullable=False)
    l3_interview_remarks=db.Column(db.String,nullable=False)
    offer_rollout_date=db.Column(db.String,nullable=False)
    joining_date=db.Column(db.String,nullable=False)
    buddy_assignment_date=db.Column(db.String,nullable=False)
    buddy_name=db.Column(db.String,nullable=False)
    candidate_dropout_date=db.Column(db.String,nullable=False)
    candidate_dropout_reason=db.Column(db.String,nullable=False)
    resume=db.Column(db.String,nullable=False)
    phone=db.Column(db.String,nullable=False)
    current_location=db.Column(db.String,nullable=False)
    current_company=db.Column(db.String,nullable=False)
    experience=db.Column(db.String,nullable=False)
    candidate_joined_date=db.Column(db.String,nullable=False)
...
class roles(db.Model):
    ...
    Tribe=db.Column(db.String, nullable=False)
    snow_id=db.Column(db.Boolean, nullable=False)
